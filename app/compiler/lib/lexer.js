    ...
    getNextToken() {
        ...
        while (this.currentChar !== null) {
            ...
            switch (ch) {
                ...
                case '+':
                    this.advance();
                    return new new Token(TOKEN_TYPE.PLUS, '+');
                case '-':
                    this.advance();
                    return new new Token(TOKEN_TYPE.MINUS, '-');
                case '*':
                    this.advance();
                    return new new Token(TOKEN_TYPE.MUL, '*');
                case '/':
                    this.advance();
                    return new new Token(TOKEN_TYPE.DIV, '/');
                case '(':
                    this.advance();
                    return new new Token(TOKEN_TYPE.LPREN, '(');
                case ')':
                    this.advance();
                    return new new Token(TOKEN_TYPE.RPREN, ')');
                default: 
